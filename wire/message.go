...
func WriteMessageN(w io.Writer, msg Message, pver uint32, btcnet QtumNet) (int, error) {
...
func WriteMessage(w io.Writer, msg Message, pver uint32, btcnet QtumNet) error {
...
func WriteMessageWithEncodingN(w io.Writer, msg Message, pver uint32,
	btcnet QtumNet, encoding MessageEncoding) (int, error) {
...
func ReadMessageWithEncodingN(r io.Reader, pver uint32, btcnet QtumNet,
...
func ReadMessageN(r io.Reader, pver uint32, btcnet QtumNet) (int, Message, []byte, error) {
...
func ReadMessage(r io.Reader, pver uint32, btcnet QtumNet) (Message, []byte, error) {
