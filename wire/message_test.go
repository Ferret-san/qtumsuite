...
func makeHeader(btcnet QtumNet, command string,
...
func TestMessage(t *testing.T) {
	...
	tests := []struct {
		...
		btcnet QtumNet // Network to use for wire encoding
		...
		{msgMerkleBlock, msgMerkleBlock, pver, MainNet, 211},
...
func TestReadMessageWireErrors(t *testing.T) {
	...
	tests := []struct {
		...
		pver    uint32  // Protocol version for wire encoding
		btcnet  QtumNet // Bitcoin network for wire encoding
