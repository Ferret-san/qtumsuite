...
func TestHeadersWire(t *testing.T) {
	...
	bh.HashStateRoot = blockOne.Header.HashStateRoot
	bh.HashUTXORoot = blockOne.Header.HashUTXORoot
	bh.PrevoutStake = blockOne.Header.PrevoutStake
	bh.BlockSig = blockOne.Header.BlockSig
