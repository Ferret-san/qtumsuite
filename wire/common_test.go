...
var mainNetGenesisHashStateRoot = chainhash.Hash([chainhash.HashSize]byte{
...
var mainNetGenesisHashUTXORoot = chainhash.Hash([chainhash.HashSize]byte{
...
var mainNetGenesisPrevoutStake = wire.OutPoint{}
...
func TestElementWireErrors(t *testing.T) {
	tests := []struct {
		...
		{QtumNet(MainNet), 0, io.ErrShortWrite, io.EOF},
	}
