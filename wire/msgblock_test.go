...
func TestBlockHash(t *testing.T) {
	// Block 1 hash.
	hashStr := "6b16e7fcae2c5f77f1b99dd3049ae021adf0588787c5b70c728f69b97d0517f6"
	wantHash, err := chainhash.NewHashFromStr(hashStr)
	if err != nil {
		t.Errorf("NewHashFromStr: %v", err)
	}
...
var blockOne = MsgBlock{
	Header: BlockHeader{
		...
		HashStateRoot: chainhash.Hash([chainhash.HashSize]byte{
			0xe9, 0x65, 0xff, 0xd0, 0x02, 0xcd, 0x6a, 0xd0,
			0xe2, 0xdc, 0x40, 0x2b, 0x80, 0x44, 0xde, 0x83,
			0x3e, 0x06, 0xb2, 0x31, 0x27, 0xea, 0x8c, 0x3d,
		...
		HashUTXORoot: chainhash.Hash([chainhash.HashSize]byte{
			0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55, 0xa6,
			0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e,
			0x5b, 0x48, 0xe0, 0x1b, 0x99, 0x6c, 0xad, 0xc0,
...
var blockOneBytes = []byte{
	...
	0xe2, 0xdc, 0x40, 0x2b, 0x80, 0x44, 0xde, 0x83,
	0x3e, 0x06, 0xb2, 0x31, 0x27, 0xea, 0x8c, 0x3d,
	0x80, 0xae, 0xc9, 0x14, 0x10, 0x77, 0x14, 0x95, // state root
	0x56, 0xe8, 0x1f, 0x17, 0x1b, 0xcc, 0x55, 0xa6,
	0xff, 0x83, 0x45, 0xe6, 0x92, 0xc0, 0xf8, 0x6e,
	0x5b, 0x48, 0xe0, 0x1b, 0x99, 0x6c, 0xad, 0xc0,
	0x01, 0x62, 0x2f, 0xb5, 0xe3, 0x63, 0xb4, 0x21, // utxo root
