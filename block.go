...
// Tx returns a wrapped transaction (qtumsuite.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (qtumsuite.Tx) for all
...
// instead provides easy access to wrapped versions (qtumsuite.Tx) of them.
