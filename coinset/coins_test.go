...
func NewCoin(index int64, value qtumsuite.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = qtumsuite.Amount(3500000)
	...
	testSimpleCoinTx, _               = qtumsuite.NewTxFromBytes(testSimpleCoinTxBytes)
