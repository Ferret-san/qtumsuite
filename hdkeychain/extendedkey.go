...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := qtumsuite.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*qtumsuite.AddressPubKeyHash, error) {
	pkHash := qtumsuite.Hash160(k.pubKeyBytes())
	return qtumsuite.NewAddressPubKeyHash(pkHash, net)
}
